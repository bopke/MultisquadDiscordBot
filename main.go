...
func main() {
	...
	_ = c.AddFunc("0 0 12 * * *", func() { rankMoneyAdd("611201074275155969", 10, "") })
	_ = c.AddFunc("0 0 13 * * *", func() { rankMoneyAdd("611202192438853642", 25, "") })
	_ = c.AddFunc("0 0 14 * * *", func() { rankMoneyAdd("651919586190557190", 45, "") })
	_ = c.AddFunc("0 0 15 * * *", func() { rankMoneyAdd("717495454409162812", 100, "") })
	_ = c.AddFunc("0 0 16 * * *", func() { rankMoneyAdd("581900782828257280", 30, "") })
	_ = c.AddFunc("0 0 17 * * *", func() { rankMoneyAdd("586314300927508521", 60, "") })
	_ = c.AddFunc("0 0 18 * * *", func() { rankMoneyAdd("658394215470071819", 120, "") })
	_ = c.AddFunc("0 0 19 * * *", func() { rankMoneyAdd("719226922432725072", 240, "") })
